...
//       subscriptionExpiry: admin.firestore.Timestamp.fromDate(expiryDate),
//       lastPaymentDate: admin.firestore.Timestamp.now(),
//       intasendCustomerId: paymentData.account || null,
//       updatedAt: new Date().toISOString()
//     };
...
//       subscriptionStatus: 'active',
//       subscriptionExpiry: admin.firestore.Timestamp.fromDate(expiryDate),
//       intasendSubscriptionId: paymentData.id || null,
//       createdAt: admin.firestore.Timestamp.now(),
//       updatedAt: admin.firestore.Timestamp.now()
//     };
...
//     return { success: true, message: 'School subscription activated', schoolId: schoolRef.id };
...
//     const currentExpiry = teacherDoc.data().subscriptionExpiry?.toDate() || new Date();
//     const newExpiry = new Date(currentExpiry);
...
//     console.log(`⚠️ Marked subscription as expired for user ${userId}`);
